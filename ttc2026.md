...
<div style="background:#f8f8f8; border:3px solid #347DBE; padding:12px; margin:12px 0; font-size:95%;">
...
<p>
Forward and backward transformations are supported as baseline cases, but the core contribution of our approach lies in handling <b>simultaneous edits on both models</b> and restoring consistency. Our approach follows a <b>rule-based propagation strategy</b>, where synchronization is achieved by leveraging the animation and constraint solving capabilities of the ProB model-checker.
</p>
...
{% include callout.html content='In automatic mode, the reset action is performed automatically before executing the test suite. This is specified in the INITIALISATION clause of the dedicated machine (e.g. `T1_BatchForward.mch`, `T2_BatchBackward.mch`, etc).' type="warning" %}
