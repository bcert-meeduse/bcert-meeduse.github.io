...
{% include warning.html content='The packaged environment has been built and validated on macOS (Apple Silicon ARM). It includes a ready-to-use Eclipse platform, configured workspaces, and example projects. If you are using another operating system or hardware architecture, please follow the <a href="https://bcert-meeduse.github.io/install.html" target="_blank">BCerT Installation Guide</a> and then jump to **Step 2: Import projects**.' %}
